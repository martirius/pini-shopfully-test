package pini.mattia.shopfullytest.ui.visibilitytracker
...
/**
 * Author is not me but https://github.com/hevinxx
 * Didn't fork it just for simplicity
 * The modification is the visible ratio of the composable exposed
 *
 *
...
fun VisibilityTracker(
    ...
    visibleRatioCallback: (ratio: Float) -> Unit,
    ...
    LaunchedEffect(key1 = visibleRatio) {
        ...
        visibleRatioCallback(visibleRatio)
    }
